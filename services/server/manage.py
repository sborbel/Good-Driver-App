...
def seed_users():
    ...
    db.session.add(User(username="Shelton Shaw", email="sshaw5@clemson.edu", password="sshaw", role="sponsor_mgr", sponsor_name=""))
    db.session.add(User(username="Sean Borbely", email="sborbel@clemson.edu", password="sborbel", role="sponsor_mgr", sponsor_name=""))
