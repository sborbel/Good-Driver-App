...
def seed_annc(): 
    ...
    db.session.add(Announcement(content="Happy early birthday Alex!", sponsor_name="Great Big Freight"))
...
def seed_messages():
    db.session.add(Message(thread_id = 1, sender_id = 6 , recipient_id = 4, created_date = "2020-09-26T18:08:49", subject = "Time off request", content = "Can I have Friday off?"))
    db.session.add(Message(thread_id = 1, sender_id = 4, recipient_id = 6, created_date = "2020-09-26T18:09:05", subject = "RE:Time off request", content = "No. Get to work."))
    db.session.add(Message(thread_id = 2, sender_id = 6, recipient_id = 5, created_date = "2020-09-26T18:09:05", subject = "Flat tire, need assistance", content = "I ran over a nail."))
    db.session.add(Message(thread_id = 2, sender_id = 5, recipient_id = 6, created_date = "2020-09-26T18:09:05", subject = "RE:Flat tire", content = "OK, I'm sending a service truck."))
    db.session.add(Message(thread_id = 2, sender_id = 6, recipient_id = 5, created_date = "2020-09-26T18:09:05", subject = "RE:Flat tire", content = "Standing by."))
    db.session.add(Message(thread_id = 3, sender_id = 7, recipient_id = 4, created_date = "2020-09-26T18:09:05", subject = "Not happy about working on Friday", content = "I'm not happy."))
    db.session.add(Message(thread_id = 3, sender_id = 4 , recipient_id = 7, created_date = "2020-09-26T18:08:49", subject = "RE: Not happy", content = "Better start looking for a new job then."))
