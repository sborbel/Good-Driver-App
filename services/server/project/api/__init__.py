...
from project.api.users.views import affiliations_namespace
...
api.add_namespace(affiliations_namespace, path="/api/affiliations")
...
api.add_namespace(reports_namespace, path="/reports")